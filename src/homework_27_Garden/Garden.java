...
public class Garden {
    ...
    public static void main(String[] args) {
        ...
        plants[0] = new Tree("Pine", 0, 0);
        plants[1] = new Flower("Tulip", 0, 0);
        ...
        for (Plant plant : plants) {
            ...
            plant.doAutumn();
            plant.doWinter();
            System.out.println(" 1 Year: Pine tree has growing is season");
            System.out.println(" 1 Year : Tulip has growing is season");
        }
        ...
        for (Plant plant : plants) {
            ...
            plant.doAutumn();
            plant.doWinter();
            System.out.println(" 2 Year:  Pine tree has growing is season ");
            System.out.println(" 2 Year: Tulip has growing is season");
        }
