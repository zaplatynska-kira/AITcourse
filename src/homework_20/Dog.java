...
public class Dog {
        ...
        сделанных всеми объектами класса. Добавить в класс статический метод, возвращающий общее количество прыжков,
         сделанных всеми собаками
    ...
    static private int numberOfDogs;
    static private int totalJumps = 0;
    private int jumps = 0;
    ...
    static void showJump() {
        System.out.println("Всего прыжков: " + totalJumps);
    }
}
